...
BASIC_PARAM_HELP: Dict[str, str] = {
    ...
    "detection_flow_mode": "Define se a sinalizacao final usa o fluxo legado hibrido ou o fluxo sequencial, no qual EWMA/CUSUM e evidencia direta da rede detectam e o RCA interpreta.",
