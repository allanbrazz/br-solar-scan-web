    ...
    for i, ts_utc in enumerate(times_utc):
        ...
        dump_by_tkey[tkey] = {
            ...
            "detection": {
                ...
                "anomaly_flag": _at(pipeline.get("anomaly_flag"), i),
                "residual_anomaly": _at(pipeline.get("residual_anomaly"), i),
                "operational_deviation_flag": _at(pipeline.get("operational_deviation_flag"), i),
                ...
                "direct_grid_evidence": _at(confidence.get("diag_direct_grid"), i),
                "zero_injection_flag": _at(confidence.get("diag_zero_inj"), i),
                "detection_origin_key": _at(pipeline.get("detection_origin_key"), i),
                "detection_origin_label": _at(pipeline.get("detection_origin_label"), i),
                "detection_origin_reason": _at(pipeline.get("detection_origin_reason"), i),
                "detection_flow_mode": _at(pipeline.get("detection_flow_mode"), i),
            },
            "chosen_total": {
                ...
                "alarm_code": _pick_first_not_none(_at(pipeline.get("alarm_code"), i), (any_row.get("alarm_code") if any_row is not None else None)),
                "alarm_sev": _pick_first_not_none(_at(pipeline.get("alarm_sev"), i), (any_row.get("alarm_sev") if any_row is not None else None)),
